...
def build_config() -> dict[str, str]:
    ...
    return dict(
        # Python settings
        python_version="3.11",
        python_install_dir=r"/Users/md.rasheduzzaman/Downloads/metagenomics-skill/.conda/phylogenetics/lib/python3.11/site-packages/",
        python_path=r"/Users/md.rasheduzzaman/Downloads/metagenomics-skill/.conda/phylogenetics/bin/python",
        ...
        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dlibdir=lib -Dprefix=/Users/md.rasheduzzaman/Downloads/metagenomics-skill/.conda/phylogenetics -Dvsenv=True --cross-file=/Users/runner/miniforge3/conda-bld/bld/rattler-build_contourpy_1769156091/build_env/meson_cross_file.txt --native-file=/Users/runner/miniforge3/conda-bld/bld/rattler-build_contourpy_1769156091/work/builddir/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
